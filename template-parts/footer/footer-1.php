...
<footer class="footer footer--style-1">
    <div class="footer__content <?php echo esc_attr($footer1_has_widgets) ? '' : 'py-2'; ?>">
        <div class="footer__container container <?php echo esc_html($footer1_has_widgets) ? 'pb-4' : 'py-2'; ?>">
            ...
            <div class="footer__bottom">
                <div
                    class="d-flex flex-column gap-3 flex-md-row <?php echo esc_attr(($footer_privacy_text || $footer_terms_text) ? 'justify-content-between' : 'justify-content-center'); ?> align-items-center text-center text-md-start">
